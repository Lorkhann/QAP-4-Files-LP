# Program description: This program is designed to display the sales difference on a monthly basis.
...
plt.plot(MonthsAbbList, MonthlySales, color="blue", marker="o")
