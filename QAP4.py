...
# for new insurance policy information to be entered and calculated for its customers.
# Written by:Liam Philpott
# Date finished July 26
#Date Finished: (Please God) July 26

# Import libraries (Learn tqdm proper).
import datetime
...
while True:
    ...
    ProvincesList = ['BC', 'AB', 'SK', 'MB', 'ON', 'QC', 'NB', 'NS', 'NL', 'NT', 'NU', 'PE', 'YT']
    ...
    PostalCode = input("Enter the postal code (A1A 1A1): ").upper()
    PhoneNum = input("Enter the phone number (000-000-0000): ")
...
# receipt statement.
    ...
    print("Spending Money, Doesn't have to feel like Spending Money!")
    print("============================================")
